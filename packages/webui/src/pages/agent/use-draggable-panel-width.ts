...
export function useDraggablePanelWidth() {
  ...
  const onPanelHandleMove = useCallback((event: React.PointerEvent<HTMLDivElement>) => {
  ...
  return { panelW, panelDragging, onPanelHandleDown, onPanelHandleMove, onPanelHandleUp }
}
